...
public class XinchouShoujikehu_LeibieController {
    ...
    public Result<List<Shoujikehu_LeibieVO>> queryList() {
        ...
        shoujikehu_leibies.forEach((shoujikehu_leibie)->{
            Shoujikehu_LeibieVO shoujikehu_LeibieVO = new Shoujikehu_LeibieVO(shoujikehu_leibie);
            shoujikehu_LeibieVO.setKehumingcheng(getKehumingcheng(shoujikehu_leibie.getKehudaima()));
            shoujikehu_LeibieVO.setLeibiemingcheng(getLeibiemingcheng(shoujikehu_leibie.getLeibieid()));
