...
public class XinchouShoujiyewuLeibieController {
    ...
    public Result<List<ShoujiyewuLeibieVO>> queryList() {
        ...
        shoujiyewuLeibies.forEach((shoujiyewuleibie)->{
            ShoujiyewuLeibieVO shoujiyewuLeibieVO = new ShoujiyewuLeibieVO(shoujiyewuleibie);
            shoujiyewuLeibieVO.setShoujileibie(getYewuName(shoujiyewuleibie.getShoujileibieid()));
    ...
    private String getYewuName(Long yewuid) {
        ...
        Shoujileibie toudiyewu = shoujileibieService.queryById(yewuid);
        if (toudiyewu == null) {
            return "";
        }
